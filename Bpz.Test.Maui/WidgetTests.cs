...
/// <summary>
/// Exercises basic bindable property behavior.
...
public class WidgetTests
{
	[Theory]
	[MetadataTestCases]
	public void ExpectMetadata(BindablePropertyAssert.BindablePropertyValues testCase)
	{
		BindablePropertyAssert.Matches(testCase);
	}

	internal class MetadataTestCasesAttribute : Xunit.Sdk.DataAttribute
	{
		private static IEnumerable<BindablePropertyAssert.BindablePropertyValues> Cases
		{
			get
			{
				yield return new()
	...
	[Fact(/* Change-handers should raise events. */)]
	...
	[Fact(/* Coercion should take place. */)]
